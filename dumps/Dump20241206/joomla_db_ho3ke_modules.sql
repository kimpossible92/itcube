...
--
-- Table structure for table `ho3ke_modules`
--

DROP TABLE IF EXISTS `ho3ke_modules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ho3ke_modules` (
