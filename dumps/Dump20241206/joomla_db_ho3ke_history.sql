...
--
-- Table structure for table `ho3ke_history`
--

DROP TABLE IF EXISTS `ho3ke_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ho3ke_history` (
...
--
-- Dumping data for table `ho3ke_history`
--

LOCK TABLES `ho3ke_history` WRITE;
/*!40000 ALTER TABLE `ho3ke_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `ho3ke_history` ENABLE KEYS */;
UNLOCK TABLES;
