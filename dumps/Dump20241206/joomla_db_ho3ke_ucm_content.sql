...
--
-- Table structure for table `ho3ke_ucm_content`
--

DROP TABLE IF EXISTS `ho3ke_ucm_content`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ho3ke_ucm_content` (
...
--
-- Dumping data for table `ho3ke_ucm_content`
--

LOCK TABLES `ho3ke_ucm_content` WRITE;
/*!40000 ALTER TABLE `ho3ke_ucm_content` DISABLE KEYS */;
/*!40000 ALTER TABLE `ho3ke_ucm_content` ENABLE KEYS */;
UNLOCK TABLES;
