...
--
-- Table structure for table `ho3ke_webauthn_credentials`
--

DROP TABLE IF EXISTS `ho3ke_webauthn_credentials`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ho3ke_webauthn_credentials` (
...
--
-- Dumping data for table `ho3ke_webauthn_credentials`
--

LOCK TABLES `ho3ke_webauthn_credentials` WRITE;
/*!40000 ALTER TABLE `ho3ke_webauthn_credentials` DISABLE KEYS */;
/*!40000 ALTER TABLE `ho3ke_webauthn_credentials` ENABLE KEYS */;
UNLOCK TABLES;
